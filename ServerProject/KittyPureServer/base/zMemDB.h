...
class zMemDB
{
    public:
        ...
        redisContext* c;
        //对于sortset
        bool getSortSet(const char* table,const char* myset, std::set<RankData>& rankSet,const DWORD begin = 0,const DWORD end = 99);
        bool getSortSet(const char* table,const char* myset, std::map<QWORD,DWORD>& valueMap,const DWORD begin = 0,const DWORD end = 99);
