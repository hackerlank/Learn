...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wx06b4ce1738867f3b";//微信开发平台应用id
	public static String APP_SECRET = "75899d02f44993100e844ecdae4baa3f";//应用对应的凭证
	//应用对应的密钥
    ...
    //财付通商户号
    public static String PARTNER = "1331489701"; //财付通商户号
	//public static String PARTNER = "1900000109";//财付通商户号
    //商户号对应的密钥
    public static String PARTNER_KEY = "ZQDPCmeJHWwoak2nd5xPy1w7fFVYeqXZ";
