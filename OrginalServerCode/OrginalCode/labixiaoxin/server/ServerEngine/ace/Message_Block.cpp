...
//static int ___n =0;
//ACE_Recursive_Thread_Mutex ___Lock;
...
{
  //ACE_Guard<ACE_Recursive_Thread_Mutex> guard(___Lock);
  //++___n;
  //printf("_________creat0________%d\n",___n);
    ...
    data_block_allocator_ (data_block_allocator)
{
	//ACE_Guard<ACE_Recursive_Thread_Mutex> guard(___Lock);
	//++___n;
	//printf("_________creat1________%d\n",___n);
  ACE_TRACE ("ACE_Data_Block::ACE_Data_Block");
