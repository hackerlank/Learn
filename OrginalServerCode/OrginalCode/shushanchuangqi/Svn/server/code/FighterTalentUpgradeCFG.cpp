...
// 文件名：     SFighterTalentUpgradeCFG.cpp
// Copyright(c) 2012-2100 上海恺英网络科技有限公司，All rights reserved.
// ******************************************************************************************************/


#include "FighterTalentUpgradeCFG.h"
#include "tinyxml.h"

CFighterTalentUpgradeLoader::~CFighterTalentUpgradeLoader()
{
	ClearData();
}

void CFighterTalentUpgradeLoader::ClearData()
{
	for(size_t i=0; i<_vecData.size();++i)
	{
		SFighterTalentUpgradeCFG *p = _vecData[i];
		delete p;
	}
	_vecData.clear();
}

bool CFighterTalentUpgradeLoader::LoadData(const std::string& strPath)
{
	ClearData();
	TiXmlDocument doc;
	...
	{
		SFighterTalentUpgradeCFG* pData = new SFighterTalentUpgradeCFG;
