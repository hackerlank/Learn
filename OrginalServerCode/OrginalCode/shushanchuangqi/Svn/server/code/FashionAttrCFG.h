...
// 文件名：     SFashionAttrCFG.h
// Copyright(c) 2012-2100 上海恺英网络科技有限公司，All rights reserved.
// ******************************************************************************************************/


#ifndef _CFASHIONATTRLOADER_H
#define _CFASHIONATTRLOADER_H
...
}; // SFashionAttrCFG define end

//data loader for the excel table
class CFashionAttrLoader
{
public:
	std::vector<SFashionAttrCFG*> _vecData;
