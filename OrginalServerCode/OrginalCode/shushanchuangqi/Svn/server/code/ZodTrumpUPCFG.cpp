...
// 文件名：     SZodTrumpUPCFG.cpp
// Copyright(c) 2012-2100 上海恺英网络科技有限公司，All rights reserved.
// ******************************************************************************************************/


#include "ZodTrumpUPCFG.h"
#include "tinyxml.h"

CZodTrumpUPLoader::~CZodTrumpUPLoader()
{
	ClearData();
}

void CZodTrumpUPLoader::ClearData()
{
	for(size_t i=0; i<_vecData.size();++i)
	{
		SZodTrumpUPCFG *p = _vecData[i];
		delete p;
	}
	_vecData.clear();
}

bool CZodTrumpUPLoader::LoadData(const std::string& strPath)
{
	ClearData();
	TiXmlDocument doc;
	...
	{
		SZodTrumpUPCFG* pData = new SZodTrumpUPCFG;
