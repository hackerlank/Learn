...
#ifndef _CSTOVEATTRLOADER_H
#define _CSTOVEATTRLOADER_H
...
}; // SStoveAttrCFG define end

//data loader for the excel table
class CStoveAttrLoader
{
public:
	std::vector<SStoveAttrCFG*> _vecData;
