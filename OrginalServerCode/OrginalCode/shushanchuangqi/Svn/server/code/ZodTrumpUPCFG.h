...
// 文件名：     SZodTrumpUPCFG.h
// Copyright(c) 2012-2100 上海恺英网络科技有限公司，All rights reserved.
// ******************************************************************************************************/


#ifndef _CZODTRUMPUPLOADER_H
#define _CZODTRUMPUPLOADER_H
...
}; // SZodTrumpUPCFG define end

//data loader for the excel table
class CZodTrumpUPLoader
{
public:
	std::vector<SZodTrumpUPCFG*> _vecData;
