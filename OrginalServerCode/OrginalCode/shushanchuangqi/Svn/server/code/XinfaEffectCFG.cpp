...
CXinfaEffectLoader::~CXinfaEffectLoader()
{
	ClearData();
}

void CXinfaEffectLoader::ClearData()
{
	for(size_t i=0; i<_vecData.size();++i)
	{
		SXinfaEffectCFG *p = _vecData[i];
		delete p;
	}
	_vecData.clear();
}

bool CXinfaEffectLoader::LoadData(const std::string& strPath)
{
	ClearData();
	TiXmlDocument doc;
	...
	{
		SXinfaEffectCFG* pData = new SXinfaEffectCFG;
		...
		if(pstr_Name != NULL)
			...
			pData->_Name = "";
		const char* pstr_costtype = pDataElem->Attribute("costtype");
		if(pstr_costtype != NULL)
			pData->_costtype = (UINT16)atoi(pstr_costtype);
		else
			pData->_costtype = 0;
		...
		if(pstr_cost != NULL)
			...
			pData->_cost = 0;
		const char* pstr_costtype2 = pDataElem->Attribute("costtype2");
		if(pstr_costtype2 != NULL)
			pData->_costtype2 = (UINT16)atoi(pstr_costtype2);
		else
			pData->_costtype2 = 0;
		const char* pstr_cost2 = pDataElem->Attribute("cost2");
		if(pstr_cost2 != NULL)
			pData->_cost2 = (UINT32)atoi(pstr_cost2);
		else
			pData->_cost2 = 0;
		...
		if(pstr_EFIGHTATTR_PHYATK_PER != NULL)
			pData->_EFIGHTATTR_PHYATK_PER = (UINT16)atoi(pstr_EFIGHTATTR_PHYATK_PER);
		else
		...
		if(pstr_EFIGHTATTR_MGCATK_PER != NULL)
			pData->_EFIGHTATTR_MGCATK_PER = (UINT16)atoi(pstr_EFIGHTATTR_MGCATK_PER);
		else
		...
		if(pstr_EFIGHTATTR_PHYDEF_PER != NULL)
			pData->_EFIGHTATTR_PHYDEF_PER = (UINT16)atoi(pstr_EFIGHTATTR_PHYDEF_PER);
		else
		...
		if(pstr_EFIGHTATTR_MGCDEF_PER != NULL)
			pData->_EFIGHTATTR_MGCDEF_PER = (UINT16)atoi(pstr_EFIGHTATTR_MGCDEF_PER);
		else
		...
		if(pstr_EFIGHTATTR_MAXHP_PER != NULL)
			pData->_EFIGHTATTR_MAXHP_PER = (UINT16)atoi(pstr_EFIGHTATTR_MAXHP_PER);
		else
		...
		if(pstr_EFIGHTATTR_SPEED_PER != NULL)
			pData->_EFIGHTATTR_SPEED_PER = (UINT16)atoi(pstr_EFIGHTATTR_SPEED_PER);
		else
		...
		if(pstr_EFIGHTATTR_HIT_PER != NULL)
			pData->_EFIGHTATTR_HIT_PER = (UINT16)atoi(pstr_EFIGHTATTR_HIT_PER);
		else
		...
		if(pstr_EFIGHTATTR_DODGE_PER != NULL)
			pData->_EFIGHTATTR_DODGE_PER = (UINT16)atoi(pstr_EFIGHTATTR_DODGE_PER);
		else
		...
		if(pstr_EFIGHTATTR_CRITICAL_PER != NULL)
			pData->_EFIGHTATTR_CRITICAL_PER = (UINT16)atoi(pstr_EFIGHTATTR_CRITICAL_PER);
		else
		...
		if(pstr_EFIGHTATTR_ANTICRITCAL_PER != NULL)
			pData->_EFIGHTATTR_ANTICRITCAL_PER = (UINT16)atoi(pstr_EFIGHTATTR_ANTICRITCAL_PER);
		else
		...
		if(pstr_EFIGHTATTR_BLOCK_PER != NULL)
			pData->_EFIGHTATTR_BLOCK_PER = (UINT16)atoi(pstr_EFIGHTATTR_BLOCK_PER);
		else
		...
		if(pstr_EFIGHTATTR_PIERCE_PER != NULL)
			pData->_EFIGHTATTR_PIERCE_PER = (UINT16)atoi(pstr_EFIGHTATTR_PIERCE_PER);
		else
		...
		if(pstr_EFIGHTATTR_COUNTER_PER != NULL)
			pData->_EFIGHTATTR_COUNTER_PER = (UINT16)atoi(pstr_EFIGHTATTR_COUNTER_PER);
		else
		...
		if(pstr_EFIGHTATTR_RESIST_PER != NULL)
			pData->_EFIGHTATTR_RESIST_PER = (UINT16)atoi(pstr_EFIGHTATTR_RESIST_PER);
		else
		...
		if(pstr_EFIGHTATTR_ANTIEFFECT != NULL)
			pData->_EFIGHTATTR_ANTIEFFECT = (UINT16)atoi(pstr_EFIGHTATTR_ANTIEFFECT);
		else
