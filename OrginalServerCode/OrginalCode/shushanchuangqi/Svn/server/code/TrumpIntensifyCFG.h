...
// 文件名：     STrumpIntensifyCFG.h
// Copyright(c) 2012-2100 上海恺英网络科技有限公司，All rights reserved.
// ******************************************************************************************************/


#ifndef _CTRUMPINTENSIFYLOADER_H
#define _CTRUMPINTENSIFYLOADER_H
...
}; // STrumpIntensifyCFG define end

//data loader for the excel table
class CTrumpIntensifyLoader
{
public:
	std::vector<STrumpIntensifyCFG*> _vecData;

	~CTrumpIntensifyLoader();
