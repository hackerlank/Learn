...
// 文件名：     SXinfaEffectCFG.h
// Copyright(c) 2012-2100 上海恺英网络科技有限公司，All rights reserved.
// ******************************************************************************************************/


#ifndef _CXINFAEFFECTLOADER_H
#define _CXINFAEFFECTLOADER_H
...
struct SXinfaEffectCFG
{
	...
	**/
	...
	物理攻击%
	**/
	UINT16	_EFIGHTATTR_PHYATK_PER;

	/**
	法术攻击%
	**/
	UINT16	_EFIGHTATTR_MGCATK_PER;

	/**
	物理防御%
	**/
	UINT16	_EFIGHTATTR_PHYDEF_PER;

	/**
	法术防御%
	**/
	UINT16	_EFIGHTATTR_MGCDEF_PER;

	/**
	最大生命%
	**/
	UINT16	_EFIGHTATTR_MAXHP_PER;

	/**
	身法%
	**/
	UINT16	_EFIGHTATTR_SPEED_PER;

	/**
	命中值%
	**/
	UINT16	_EFIGHTATTR_HIT_PER;

	/**
	闪避值%
	**/
	UINT16	_EFIGHTATTR_DODGE_PER;

	/**
	暴击值%
	**/
	UINT16	_EFIGHTATTR_CRITICAL_PER;

	/**
	稳固值%
	**/
	UINT16	_EFIGHTATTR_ANTICRITCAL_PER;

	/**
	格挡值%
	**/
	UINT16	_EFIGHTATTR_BLOCK_PER;

	/**
	穿透值%
	**/
	UINT16	_EFIGHTATTR_PIERCE_PER;

	/**
	反击值%
	**/
	UINT16	_EFIGHTATTR_COUNTER_PER;

	/**
	压制值%
	**/
	UINT16	_EFIGHTATTR_RESIST_PER;

	/**
	法术抵抗
	**/
	UINT16	_EFIGHTATTR_ANTIEFFECT;
}; // SXinfaEffectCFG define end

//data loader for the excel table
class CXinfaEffectLoader
{
public:
	std::vector<SXinfaEffectCFG*> _vecData;
