...
class CGate2GameCommClt : public IProtocol
{
public:
	/////////////////////以下为发送函数/////////////////////
	//发送：心跳
...
protected:
	/////////////////////协议处理函数/////////////////////
	bool _DoRecv_UserEnterNtf(const char* pBuf, UINT32 dwLen);
	bool _DoRecv_KickUserOffLine(const char* pBuf, UINT32 dwLen);

private:
	typedef bool (CGate2GameCommClt::*THandleFunc)(const char* pBuf, UINT32 dwLen);
