...
package net.protocol.yaMenTaskProt
{
	...
	/**
	 * 函数FlushTask[刷新衙门任务列表]的返回事件
	 */
	public final class TEvt_FlushTask extends Event
	{
		public static const DATA_RETURN:String = "YaMenTaskProt_FlushTask";
		public static const DATA_ERROR:String = "YaMenTaskProt_FlushTask_Error";
