...
//  File Name:    SRetParam_ActiveTrump.as
//  Purpose:      激活法宝
...
package net.protocol.itemProt
{
	 ...
	 * 激活法宝的返回的参数组成的结构体
	 */
	public final class SRetParam_ActiveTrump
	{
		...
		public function toXML(name_:String = null):XML
		{
			var topXml:XML
			if(name_ != null && name_ != "")
				topXml = <SRetParam_ActiveTrump _name_={name_} eResult={eResult}/>;
			else
				topXml = <SRetParam_ActiveTrump eResult={eResult}/>;
			if(vecTrump != null)
			{
