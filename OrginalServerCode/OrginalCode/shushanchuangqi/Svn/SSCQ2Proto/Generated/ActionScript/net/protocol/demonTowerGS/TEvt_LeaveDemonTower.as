...
package net.protocol.demonTowerGS
{
	...
	/**
	 * 函数LeaveDemonTower[离开锁妖塔]的返回事件
	 */
	public final class TEvt_LeaveDemonTower extends Event
	{
		public static const DATA_RETURN:String = "DemonTowerGS_LeaveDemonTower";
		public static const DATA_ERROR:String = "DemonTowerGS_LeaveDemonTower_Error";
