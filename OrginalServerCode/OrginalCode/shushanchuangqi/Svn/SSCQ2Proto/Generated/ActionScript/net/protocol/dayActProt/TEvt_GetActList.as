...
package net.protocol.dayActProt
{
	...
	/**
	 * 函数GetActList[获取活动列表]的返回事件
	 */
	public final class TEvt_GetActList extends Event
	{
		public static const DATA_RETURN:String = "DayActProt_GetActList";
		public static const DATA_ERROR:String = "DayActProt_GetActList_Error";
