...
//  File Name:    SRetParam_UnEquipTrump.as
//  Purpose:      卸下法宝
...
package net.protocol.itemProt
{
	 ...
	 * 卸下法宝的返回的参数组成的结构体
	 */
	public final class SRetParam_UnEquipTrump
	{
		...
		public function toXML(name_:String = null):XML
		{
			var topXml:XML
			if(name_ != null && name_ != "")
				topXml = <SRetParam_UnEquipTrump _name_={name_} eResult={eResult}/>;
			else
				topXml = <SRetParam_UnEquipTrump eResult={eResult}/>;
			if(vecTrump != null)
			{
