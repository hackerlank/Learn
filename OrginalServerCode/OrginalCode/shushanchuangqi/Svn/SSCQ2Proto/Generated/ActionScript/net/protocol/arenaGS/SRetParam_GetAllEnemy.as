...
//  File Name:    SRetParam_GetAllEnemy.as
//  Purpose:      请求对手信息
...
package net.protocol.arenaGS
{
	 ...
	 * 请求对手信息的返回的参数组成的结构体
	 */
	public final class SRetParam_GetAllEnemy
	{
		...
		public function toXML(name_:String = null):XML
		{
			var topXml:XML
			if(name_ != null && name_ != "")
				topXml = <SRetParam_GetAllEnemy _name_={name_} eResult={eResult}/>;
			else
				topXml = <SRetParam_GetAllEnemy eResult={eResult}/>;
