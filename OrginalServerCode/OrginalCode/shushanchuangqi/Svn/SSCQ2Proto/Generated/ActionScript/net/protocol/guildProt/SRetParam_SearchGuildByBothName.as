...
//  File Name:    SRetParam_SearchGuildByBothName.as
//  Purpose:      根据帮主搜索帮派
...
package net.protocol.guildProt
{
	 ...
	 */
	public final class SRetParam_SearchGuildByBothName
	{
		...
		public function toXML(name_:String = null):XML
		{
			var topXml:XML
			if(name_ != null && name_ != "")
				topXml = <SRetParam_SearchGuildByBothName _name_={name_} eResult={eResult}/>;
			else
				topXml = <SRetParam_SearchGuildByBothName eResult={eResult}/>;
