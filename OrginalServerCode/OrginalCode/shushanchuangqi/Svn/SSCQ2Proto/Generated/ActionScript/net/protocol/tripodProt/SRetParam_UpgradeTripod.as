...
//  File Name:    SRetParam_UpgradeTripod.as
//  Purpose:      升级九疑鼎
...
package net.protocol.tripodProt
{
	 ...
	 * 升级九疑鼎的返回的参数组成的结构体
	 */
	public final class SRetParam_UpgradeTripod
	{
		...
		public function toXML(name_:String = null):XML
		{
			var topXml:XML
			if(name_ != null && name_ != "")
				topXml = <SRetParam_UpgradeTripod _name_={name_} eResult={eResult}/>;
			else
				topXml = <SRetParam_UpgradeTripod eResult={eResult}/>;
			if(vecTripods != null)
			{
