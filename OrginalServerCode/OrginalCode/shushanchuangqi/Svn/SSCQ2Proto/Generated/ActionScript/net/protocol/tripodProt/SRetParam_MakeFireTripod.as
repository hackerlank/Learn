...
//  File Name:    SRetParam_MakeFireTripod.as
//  Purpose:      九疑鼎祈火(炼丹)
...
{
	/**
	 * 九疑鼎祈火(炼丹)的返回的参数组成的结构体
	 */
	public final class SRetParam_MakeFireTripod
	{
		...
		public function toXML(name_:String = null):XML
		{
			var topXml:XML
			if(name_ != null && name_ != "")
				topXml = <SRetParam_MakeFireTripod _name_={name_} eResult={eResult}/>;
			else
				topXml = <SRetParam_MakeFireTripod eResult={eResult}/>;
			if(vecTripods != null)
			{
