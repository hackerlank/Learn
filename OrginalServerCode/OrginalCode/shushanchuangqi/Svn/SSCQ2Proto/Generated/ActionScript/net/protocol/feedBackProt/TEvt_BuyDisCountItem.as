...
package net.protocol.feedBackProt
{
	...
	/**
	 * 函数BuyDisCountItem[购买折扣物品]的返回事件
	 */
	public final class TEvt_BuyDisCountItem extends Event
	{
		public static const DATA_RETURN:String = "FeedBackProt_BuyDisCountItem";
		public static const DATA_ERROR:String = "FeedBackProt_BuyDisCountItem_Error";
