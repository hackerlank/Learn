...
//  File Name:    SRetParam_UpgradeTrump.as
//  Purpose:      祭炼法宝
...
package net.protocol.itemProt
{
	 ...
	 * 祭炼法宝的返回的参数组成的结构体
	 */
	public final class SRetParam_UpgradeTrump
	{
		...
		public function toXML(name_:String = null):XML
		{
			var topXml:XML
			if(name_ != null && name_ != "")
				topXml = <SRetParam_UpgradeTrump _name_={name_} eResult={eResult}/>;
			else
				topXml = <SRetParam_UpgradeTrump eResult={eResult}/>;
			if(vecTrump != null)
			{
