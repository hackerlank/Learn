...
//  File Name:    SRetParam_SearchGuildByName.as
//  Purpose:      搜索帮派
...
package net.protocol.guildProt
{
	 ...
	 * 搜索帮派的返回的参数组成的结构体
	 */
	public final class SRetParam_SearchGuildByName
	{
		...
		public function toXML(name_:String = null):XML
		{
			var topXml:XML
			if(name_ != null && name_ != "")
				topXml = <SRetParam_SearchGuildByName _name_={name_} eResult={eResult}/>;
			else
				topXml = <SRetParam_SearchGuildByName eResult={eResult}/>;
