...
//  File Name:    SRetParam_GetGuildRankInfo.as
//  Purpose:      获取战功榜帮派排名信息
...
{
	/**
	 * 获取战功榜帮派排名信息的返回的参数组成的结构体
	 */
	public final class SRetParam_GetGuildRankInfo
	{
		...
		public function toXML(name_:String = null):XML
		{
			var topXml:XML
			if(name_ != null && name_ != "")
				topXml = <SRetParam_GetGuildRankInfo _name_={name_} eResult={eResult} dwMaxCount={dwMaxCount} dwCurIndex={dwCurIndex}/>;
			else
				topXml = <SRetParam_GetGuildRankInfo eResult={eResult} dwMaxCount={dwMaxCount} dwCurIndex={dwCurIndex}/>;
			if(vecInfo != null)
			{
