...
package net.protocol.achievementProt
{
	...
	/**
	 * 函数TakePrize[获取成就奖励]的返回事件
	 */
	public final class TEvt_TakePrize extends Event
	{
		public static const DATA_RETURN:String = "AchievementProt_TakePrize";
		public static const DATA_ERROR:String = "AchievementProt_TakePrize_Error";
