...
package net.protocol.shushanweiweiProt
{
	...
	/**
	 * 函数TakePrize[获取礼包]的返回事件
	 */
	public final class TEvt_TakePrize extends Event
	{
		public static const DATA_RETURN:String = "ShushanweiweiProt_TakePrize";
		public static const DATA_ERROR:String = "ShushanweiweiProt_TakePrize_Error";
