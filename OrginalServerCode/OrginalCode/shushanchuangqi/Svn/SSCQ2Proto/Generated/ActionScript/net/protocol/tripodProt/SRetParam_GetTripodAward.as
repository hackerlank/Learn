...
//  File Name:    SRetParam_GetTripodAward.as
//  Purpose:      获取九疑鼎炼丹果实
...
{
	/**
	 * 获取九疑鼎炼丹果实的返回的参数组成的结构体
	 */
	public final class SRetParam_GetTripodAward
	{
		...
		public function toXML(name_:String = null):XML
		{
			var topXml:XML
			if(name_ != null && name_ != "")
				topXml = <SRetParam_GetTripodAward _name_={name_} eResult={eResult}/>;
			else
				topXml = <SRetParam_GetTripodAward eResult={eResult}/>;
			if(vecTripods != null)
			{
