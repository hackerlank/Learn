...
//  Purpose:      协议:蜀山论剑相关协议, 函数:使用蜀山论剑技能
...
package net.protocol.shushanBattleProt
{
	...
	/**
	 * 函数UseSkill[使用蜀山论剑技能]的返回事件
	 */
	public final class TEvt_UseSkill extends Event
	{
		public static const DATA_RETURN:String = "ShushanBattleProt_UseSkill";
		public static const DATA_ERROR:String = "ShushanBattleProt_UseSkill_Error";
