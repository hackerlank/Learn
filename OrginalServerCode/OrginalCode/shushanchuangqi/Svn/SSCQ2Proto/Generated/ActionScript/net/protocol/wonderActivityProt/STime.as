...
package net.protocol.wonderActivityProt
{
	...
	public final class STime
	{
		 ...
		 * 辅助创建函数
		 */
		public static function create(wWActID:uint, dwAdvTime:uint, dwBeginTime:uint, dwEndTime:uint, dwRetainTime:uint):STime
		{
		...
		public function toXML(name_:String = null):XML
		{
			var topXml:XML
			if(name_ != null && name_ != "")
				topXml = <STime _name_={name_} wWActID={wWActID} dwAdvTime={dwAdvTime} dwBeginTime={dwBeginTime} dwEndTime={dwEndTime} dwRetainTime={dwRetainTime}/>;
			else
				topXml = <STime wWActID={wWActID} dwAdvTime={dwAdvTime} dwBeginTime={dwBeginTime} dwEndTime={dwEndTime} dwRetainTime={dwRetainTime}/>;
			return topXml;
		}
