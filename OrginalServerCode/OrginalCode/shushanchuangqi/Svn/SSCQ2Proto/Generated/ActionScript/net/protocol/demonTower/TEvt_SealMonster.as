...
package net.protocol.demonTower
{
	...
	/**
	 * 函数SealMonster[封印怪物(暂时不用)]的返回事件
	 */
	public final class TEvt_SealMonster extends Event
	{
		public static const DATA_RETURN:String = "DemonTower_SealMonster";
		public static const DATA_ERROR:String = "DemonTower_SealMonster_Error";
