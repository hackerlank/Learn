...
package net.protocol.globalChatProt
{
	...
	{
		public static const DATA_RECEIVE:String = "GlobalChatProt_SystemMsgNotify";
		public static const DATA_ERROR:String = "GlobalChatProt_SystemMsgNotify_Error";

		public var eChannelType:uint; //(枚举类型：EChannelType)通道类型
		public var strInfo:String; //聊天信息
		public var eSubType:uint; //(枚举类型：EChannelSubType)额外信息
