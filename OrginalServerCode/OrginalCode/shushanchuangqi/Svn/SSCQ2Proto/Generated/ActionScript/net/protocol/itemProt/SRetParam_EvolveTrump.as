...
//  File Name:    SRetParam_EvolveTrump.as
//  Purpose:      提升法宝品级
...
package net.protocol.itemProt
{
	 ...
	 * 提升法宝品级的返回的参数组成的结构体
	 */
	public final class SRetParam_EvolveTrump
	{
		...
		public function toXML(name_:String = null):XML
		{
			var topXml:XML
			if(name_ != null && name_ != "")
				topXml = <SRetParam_EvolveTrump _name_={name_} eResult={eResult}/>;
			else
				topXml = <SRetParam_EvolveTrump eResult={eResult}/>;
			if(vecTrump != null)
			{
