...
function OnUseItem274(wItemID, wCount, eBind, qwMercenID)
    ...
    local items = {{201,1},{201,2},{204,1},{204,2},{321,1},{321,2},{206,1},{206,2},{312,1},{312,2},{2,1000},{2,1500},{2,2000},{9,1000},{9,1500},{9,2000},{3,10},{3,20},{1704,1},{1704,2},{1708,1},{1708,2}}
    local len = #items;
    if len  == 0 then
        return 0
	end
