...
function OnUseItem281(wItemID, wCount, eBind, qwMercenID)
    ...
    local items = {{2,20000},{2,25000},{2,30000},{9,2000},{9,2500},{9,3000},{202,1},{202,2},{205,1},{205,2},{322,1},{322,2},{207,1},{207,2},{313,1},{313,2}}
    local len = #items;
    if len  == 0 then
        return 0
	end
