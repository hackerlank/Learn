...
function OnUseItem178(wItemID, wCount, eBind, qwMercenID)
    ...
    if (pack == nil) then
	    ...
	    local sitems = {}
    local prob = {1250,2500,3750,5000,6250,7500,8750,10000}
    local items = {{170,1},{171,1},{172,1},{173,1},{174,1},{175,1},{176,1},{177,1}}
    local len = #items;
    if len  == 0 then
        return 0
	end
    local emptypack = pack:GetEmptyCount();
    local needpack = #items
