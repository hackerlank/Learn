...
public:
    ...
    bool Get(long long& val) const;		///< Get a big integer value. Returns false if cell does not contain a big integer or an integer.
    ...
    long long GetBigInteger() const; 			///< Get an big integer value. Returns 0 if cell does not contain an big integer.
