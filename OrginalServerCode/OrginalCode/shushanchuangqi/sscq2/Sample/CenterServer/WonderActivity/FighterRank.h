#ifndef FIGHTERRANK_H__ 
#define FIGHTERRANK_H__
#include "stdafx.h"
#include "WonderActivity.h"
#include "UserMgr.h"

class CFighterRank : public CWonderActivity
{
    public:
        CFighterRank(UINT16 wType) : CWonderActivity(wType) { _setRank.clear(); }
        virtual ~CFighterRank(){};
        void     OnRetain();
        void     OnEnd();
