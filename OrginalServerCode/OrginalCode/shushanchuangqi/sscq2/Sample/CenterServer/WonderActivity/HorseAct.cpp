...
bool CHorseActMgr::CheckConds(UINT32 wConds)
{
...
void CHorseActMgr::TakePrize(UINT64 &qwPlayerID,UINT32 wCond)
{
    UINT16 wActID = GetActID();
...
void CHorseActMgr::OnEnd()
{
   ...
   for(auto &oIt : wConds)
   {
        UINT32 dwCount = CUserMgr::GetCount(NGame2CenterComm::eActHorse,oIt); 
...
void CHorseActMgr::GetRoleStateByActID(UINT64 qwRoleID,UINT16 wActID,TVecRoleStatus& vecRet)
{
    UINT32 dwMaxCount;
    TVecUINT32 vecConds;
    GetConds(vecConds);
...
UINT8 CHorseActMgr::GetPrizeStateForRole(UINT64 qwRoleID,UINT16 wActID,UINT32 wCond)
{
...
UINT32 CHorseActMgr::GetCurRoleCount(UINT16 wActID,UINT32 wCond)
{
    UINT32 dwCount = 0;
    ...
    dwCount = CUserMgr::GetCount(NGame2CenterComm::eActHorse,wCond);
    return dwCount;
}
