...
// 文件名：     SJiuyidinglevelCFG.cpp
// Copyright(c) 2012-2100 上海恺英网络科技有限公司，All rights reserved.
// ******************************************************************************************************/


#include "JiuyidinglevelCFG.h"
#include "tinyxml.h"

CJiuyidinglevelLoader::~CJiuyidinglevelLoader()
{
	ClearData();
}

void CJiuyidinglevelLoader::ClearData()
{
	for(size_t i=0; i<_vecData.size();++i)
	{
		SJiuyidinglevelCFG *p = _vecData[i];
		delete p;
	}
	_vecData.clear();
}

bool CJiuyidinglevelLoader::LoadData(const std::string& strPath)
{
	ClearData();
	TiXmlDocument doc;
	...
	{
		SJiuyidinglevelCFG* pData = new SJiuyidinglevelCFG;
