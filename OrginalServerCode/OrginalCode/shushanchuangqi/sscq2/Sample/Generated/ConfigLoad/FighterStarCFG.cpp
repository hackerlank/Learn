...
CFighterStarLoader::~CFighterStarLoader()
{
	ClearData();
}

void CFighterStarLoader::ClearData()
{
	for(size_t i=0; i<_vecData.size();++i)
	{
		SFighterStarCFG *p = _vecData[i];
		delete p;
	}
	_vecData.clear();
}

bool CFighterStarLoader::LoadData(const std::string& strPath)
{
	ClearData();
	TiXmlDocument doc;
	...
	{
		SFighterStarCFG* pData = new SFighterStarCFG;
		...
		if(pstr_EFIGHTATTR_PHYATK != NULL)
			pData->_EFIGHTATTR_PHYATK = (UINT8)atoi(pstr_EFIGHTATTR_PHYATK);
		else
		...
		if(pstr_EFIGHTATTR_MGCATK != NULL)
			pData->_EFIGHTATTR_MGCATK = (UINT8)atoi(pstr_EFIGHTATTR_MGCATK);
		else
		...
		if(pstr_EFIGHTATTR_PHYDEF != NULL)
			pData->_EFIGHTATTR_PHYDEF = (UINT8)atoi(pstr_EFIGHTATTR_PHYDEF);
		else
		...
		if(pstr_EFIGHTATTR_MGCDEF != NULL)
			pData->_EFIGHTATTR_MGCDEF = (UINT8)atoi(pstr_EFIGHTATTR_MGCDEF);
		else
		...
		if(pstr_EFIGHTATTR_MAXHP != NULL)
			pData->_EFIGHTATTR_MAXHP = (UINT8)atoi(pstr_EFIGHTATTR_MAXHP);
		else
		...
		if(pstr_EFIGHTATTR_DODGE != NULL)
			pData->_EFIGHTATTR_DODGE = (UINT8)atoi(pstr_EFIGHTATTR_DODGE);
		else
		...
		if(pstr_EFIGHTATTR_CRITICAL != NULL)
			pData->_EFIGHTATTR_CRITICAL = (UINT8)atoi(pstr_EFIGHTATTR_CRITICAL);
		else
		...
		if(pstr_EFIGHTATTR_ANTICRITCAL != NULL)
			pData->_EFIGHTATTR_ANTICRITCAL = (UINT8)atoi(pstr_EFIGHTATTR_ANTICRITCAL);
		else
		...
		if(pstr_EFIGHTATTR_PIERCE != NULL)
			pData->_EFIGHTATTR_PIERCE = (UINT8)atoi(pstr_EFIGHTATTR_PIERCE);
		else
		...
		if(pstr_EFIGHTATTR_COUNTER != NULL)
			pData->_EFIGHTATTR_COUNTER = (UINT8)atoi(pstr_EFIGHTATTR_COUNTER);
		else
		...
		if(pstr_EFIGHTATTR_RESIST != NULL)
			pData->_EFIGHTATTR_RESIST = (UINT8)atoi(pstr_EFIGHTATTR_RESIST);
		else
		...
		if(pstr_EFIGHTATTR_BLOCK != NULL)
			pData->_EFIGHTATTR_BLOCK = (UINT8)atoi(pstr_EFIGHTATTR_BLOCK);
		else
		...
		if(pstr_EFIGHTATTR_PHYRDC != NULL)
			pData->_EFIGHTATTR_PHYRDC = (UINT8)atoi(pstr_EFIGHTATTR_PHYRDC);
		else
		...
		if(pstr_EFIGHTATTR_MGCRDC != NULL)
			pData->_EFIGHTATTR_MGCRDC = (UINT8)atoi(pstr_EFIGHTATTR_MGCRDC);
		else
		...
		if(pstr_EFIGHTATTR_HITRATE != NULL)
			pData->_EFIGHTATTR_HITRATE = (UINT8)atoi(pstr_EFIGHTATTR_HITRATE);
		else
		...
		if(pstr_EFIGHTATTR_DODGERATE != NULL)
			pData->_EFIGHTATTR_DODGERATE = (UINT8)atoi(pstr_EFIGHTATTR_DODGERATE);
		else
		...
		if(pstr_EFIGHTATTR_CRTRATE != NULL)
			pData->_EFIGHTATTR_CRTRATE = (UINT8)atoi(pstr_EFIGHTATTR_CRTRATE);
		else
		...
		if(pstr_EFIGHTATTR_ANTICRTRATE != NULL)
			pData->_EFIGHTATTR_ANTICRTRATE = (UINT8)atoi(pstr_EFIGHTATTR_ANTICRTRATE);
		else
		...
		if(pstr_EFIGHTATTR_BLOCKRATE != NULL)
			pData->_EFIGHTATTR_BLOCKRATE = (UINT8)atoi(pstr_EFIGHTATTR_BLOCKRATE);
		else
		...
		if(pstr_EFIGHTATTR_PIERCERATE != NULL)
			pData->_EFIGHTATTR_PIERCERATE = (UINT8)atoi(pstr_EFIGHTATTR_PIERCERATE);
		else
		...
		if(pstr_EFIGHTATTR_COUNTERRATE != NULL)
			pData->_EFIGHTATTR_COUNTERRATE = (UINT8)atoi(pstr_EFIGHTATTR_COUNTERRATE);
		else
		...
		if(pstr_EFIGHTATTR_RESISTRATE != NULL)
			pData->_EFIGHTATTR_RESISTRATE = (UINT8)atoi(pstr_EFIGHTATTR_RESISTRATE);
		else
		...
		if(pstr_EFIGHTATTR_INITAURA != NULL)
			pData->_EFIGHTATTR_INITAURA = (UINT8)atoi(pstr_EFIGHTATTR_INITAURA);
		else
		...
		if(pstr_EFIGHTATTR_MAXAURA != NULL)
			pData->_EFIGHTATTR_MAXAURA = (UINT8)atoi(pstr_EFIGHTATTR_MAXAURA);
		else
		...
		if(pstr_EFIGHTATTR_CRIEXTRAADD != NULL)
			pData->_EFIGHTATTR_CRIEXTRAADD = (UINT8)atoi(pstr_EFIGHTATTR_CRIEXTRAADD);
		else
		...
		if(pstr_EFIGHTATTR_CRIEXTRARDC != NULL)
			pData->_EFIGHTATTR_CRIEXTRARDC = (UINT8)atoi(pstr_EFIGHTATTR_CRIEXTRARDC);
		else
		...
		if(pstr_EFIGHTATTR_METALATK != NULL)
			pData->_EFIGHTATTR_METALATK = (UINT8)atoi(pstr_EFIGHTATTR_METALATK);
		else
		...
		if(pstr_EFIGHTATTR_WOODATK != NULL)
			pData->_EFIGHTATTR_WOODATK = (UINT8)atoi(pstr_EFIGHTATTR_WOODATK);
		else
		...
		if(pstr_EFIGHTATTR_WATERATK != NULL)
			pData->_EFIGHTATTR_WATERATK = (UINT8)atoi(pstr_EFIGHTATTR_WATERATK);
		else
		...
		if(pstr_EFIGHTATTR_FIREATK != NULL)
			pData->_EFIGHTATTR_FIREATK = (UINT8)atoi(pstr_EFIGHTATTR_FIREATK);
		else
		...
		if(pstr_EFIGHTATTR_EARTHATK != NULL)
			pData->_EFIGHTATTR_EARTHATK = (UINT8)atoi(pstr_EFIGHTATTR_EARTHATK);
		else
		...
		if(pstr_EFIGHTATTR_METALDEF != NULL)
			pData->_EFIGHTATTR_METALDEF = (UINT8)atoi(pstr_EFIGHTATTR_METALDEF);
		else
		...
		if(pstr_EFIGHTATTR_WOODDEF != NULL)
			pData->_EFIGHTATTR_WOODDEF = (UINT8)atoi(pstr_EFIGHTATTR_WOODDEF);
		else
		...
		if(pstr_EFIGHTATTR_WATERDEF != NULL)
			pData->_EFIGHTATTR_WATERDEF = (UINT8)atoi(pstr_EFIGHTATTR_WATERDEF);
		else
		...
		if(pstr_EFIGHTATTR_FIREDEF != NULL)
			pData->_EFIGHTATTR_FIREDEF = (UINT8)atoi(pstr_EFIGHTATTR_FIREDEF);
		else
		...
		if(pstr_EFIGHTATTR_EARTHDEF != NULL)
			pData->_EFIGHTATTR_EARTHDEF = (UINT8)atoi(pstr_EFIGHTATTR_EARTHDEF);
		else
		...
		if(pstr_EFIGHTATTR_PHYATK_PER != NULL)
			pData->_EFIGHTATTR_PHYATK_PER = (UINT8)atoi(pstr_EFIGHTATTR_PHYATK_PER);
		else
		...
		if(pstr_EFIGHTATTR_MGCATK_PER != NULL)
			pData->_EFIGHTATTR_MGCATK_PER = (UINT8)atoi(pstr_EFIGHTATTR_MGCATK_PER);
		else
		...
		if(pstr_EFIGHTATTR_PHYDEF_PER != NULL)
			pData->_EFIGHTATTR_PHYDEF_PER = (UINT8)atoi(pstr_EFIGHTATTR_PHYDEF_PER);
		else
		...
		if(pstr_EFIGHTATTR_MGCDEF_PER != NULL)
			pData->_EFIGHTATTR_MGCDEF_PER = (UINT8)atoi(pstr_EFIGHTATTR_MGCDEF_PER);
		else
		...
		if(pstr_EFIGHTATTR_MAXHP_PER != NULL)
			pData->_EFIGHTATTR_MAXHP_PER = (UINT8)atoi(pstr_EFIGHTATTR_MAXHP_PER);
		else
		...
		if(pstr_EFIGHTATTR_SPEED_PER != NULL)
			pData->_EFIGHTATTR_SPEED_PER = (UINT8)atoi(pstr_EFIGHTATTR_SPEED_PER);
		else
		...
		if(pstr_EFIGHTATTR_HIT_PER != NULL)
			pData->_EFIGHTATTR_HIT_PER = (UINT8)atoi(pstr_EFIGHTATTR_HIT_PER);
		else
		...
		if(pstr_EFIGHTATTR_DODGE_PER != NULL)
			pData->_EFIGHTATTR_DODGE_PER = (UINT8)atoi(pstr_EFIGHTATTR_DODGE_PER);
		else
		...
		if(pstr_EFIGHTATTR_CRITICAL_PER != NULL)
			pData->_EFIGHTATTR_CRITICAL_PER = (UINT8)atoi(pstr_EFIGHTATTR_CRITICAL_PER);
		else
		...
		if(pstr_EFIGHTATTR_ANTICRITCAL_PER != NULL)
			pData->_EFIGHTATTR_ANTICRITCAL_PER = (UINT8)atoi(pstr_EFIGHTATTR_ANTICRITCAL_PER);
		else
		...
		if(pstr_EFIGHTATTR_BLOCK_PER != NULL)
			pData->_EFIGHTATTR_BLOCK_PER = (UINT8)atoi(pstr_EFIGHTATTR_BLOCK_PER);
		else
		...
		if(pstr_EFIGHTATTR_PIERCE_PER != NULL)
			pData->_EFIGHTATTR_PIERCE_PER = (UINT8)atoi(pstr_EFIGHTATTR_PIERCE_PER);
		else
		...
		if(pstr_EFIGHTATTR_COUNTER_PER != NULL)
			pData->_EFIGHTATTR_COUNTER_PER = (UINT8)atoi(pstr_EFIGHTATTR_COUNTER_PER);
		else
		...
		if(pstr_EFIGHTATTR_RESIST_PER != NULL)
			pData->_EFIGHTATTR_RESIST_PER = (UINT8)atoi(pstr_EFIGHTATTR_RESIST_PER);
		else
		...
		if(pstr_EFIGHTATTR_ANTIEFFECT != NULL)
			pData->_EFIGHTATTR_ANTIEFFECT = (UINT8)atoi(pstr_EFIGHTATTR_ANTIEFFECT);
		else
