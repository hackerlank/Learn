...
// 文件名：     SFighterCuiTiCFG.h
// Copyright(c) 2012-2100 上海恺英网络科技有限公司，All rights reserved.
// ******************************************************************************************************/


#ifndef _CFIGHTERCUITILOADER_H
#define _CFIGHTERCUITILOADER_H
...
}; // SFighterCuiTiCFG define end

//data loader for the excel table
class CFighterCuiTiLoader
{
public:
	std::vector<SFighterCuiTiCFG*> _vecData;
