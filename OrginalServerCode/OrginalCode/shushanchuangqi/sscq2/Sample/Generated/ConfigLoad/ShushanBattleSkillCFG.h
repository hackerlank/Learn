...
// 文件名：     SShushanBattleSkillCFG.h
// Copyright(c) 2012-2100 上海恺英网络科技有限公司，All rights reserved.
// ******************************************************************************************************/


#ifndef _CSHUSHANBATTLESKILLLOADER_H
#define _CSHUSHANBATTLESKILLLOADER_H
...
struct SShushanBattleSkillCFG
{
	...
	**/
	...
	反击伤害增加
	**/
	UINT32	_EFIGHTATTR_COUTEREXTRAADD;

	/**
	反击伤害减免
	**/
	UINT32	_EFIGHTATTR_COUTEREXTRARDC;
}; // SShushanBattleSkillCFG define end

//data loader for the excel table
class CShushanBattleSkillLoader
{
public:
	std::vector<SShushanBattleSkillCFG*> _vecData;

	~CShushanBattleSkillLoader();
