...
// 文件名：     SFighterTaoismCFG.h
// Copyright(c) 2012-2100 上海恺英网络科技有限公司，All rights reserved.
// ******************************************************************************************************/


#ifndef _CFIGHTERTAOISMLOADER_H
#define _CFIGHTERTAOISMLOADER_H
...
}; // SFighterTaoismCFG define end

//data loader for the excel table
class CFighterTaoismLoader
{
public:
	std::vector<SFighterTaoismCFG*> _vecData;

	~CFighterTaoismLoader();
