...
// 文件名：     SFighterCombinationEffectCFG.h
// Copyright(c) 2012-2100 上海恺英网络科技有限公司，All rights reserved.
// ******************************************************************************************************/


#ifndef _CFIGHTERCOMBINATIONEFFECTLOADER_H
#define _CFIGHTERCOMBINATIONEFFECTLOADER_H
...
struct SFighterCombinationEffectCFG
{
	/**
	ID
	**/
...
}; // SFighterCombinationEffectCFG define end

//data loader for the excel table
class CFighterCombinationEffectLoader
{
public:
	std::vector<SFighterCombinationEffectCFG*> _vecData;

	~CFighterCombinationEffectLoader();
