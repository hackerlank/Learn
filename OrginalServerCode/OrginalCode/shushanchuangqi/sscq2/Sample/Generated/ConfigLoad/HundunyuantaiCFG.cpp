...
// 文件名：     SHundunyuantaiCFG.cpp
// Copyright(c) 2012-2100 上海恺英网络科技有限公司，All rights reserved.
// ******************************************************************************************************/


#include "HundunyuantaiCFG.h"
#include "tinyxml.h"

CHundunyuantaiLoader::~CHundunyuantaiLoader()
{
	ClearData();
}

void CHundunyuantaiLoader::ClearData()
{
	for(size_t i=0; i<_vecData.size();++i)
	{
		SHundunyuantaiCFG *p = _vecData[i];
		delete p;
	}
	_vecData.clear();
}

bool CHundunyuantaiLoader::LoadData(const std::string& strPath)
{
	ClearData();
	TiXmlDocument doc;
	...
	{
		SHundunyuantaiCFG* pData = new SHundunyuantaiCFG;
