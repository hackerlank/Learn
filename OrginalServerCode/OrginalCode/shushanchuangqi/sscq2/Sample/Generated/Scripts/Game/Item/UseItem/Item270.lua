...
function OnUseItem270(wItemID, wCount, eBind, qwMercenID)
    ...
    local items = {{201,1},{201,2},{201,3},{204,1},{204,2},{204,3},{321,1},{321,2},{321,3},{206,1},{206,2},{206,3},{312,1},{312,2},{312,3},{2,2000},{2,2500},{2,3000},{9,2000},{9,2500},{9,3000},{1704,1},{1704,2},{1708,1},{1708,2}}
    local len = #items;
    if len  == 0 then
        return 0
	end
