...
function OnUseItem272(wItemID, wCount, eBind, qwMercenID)
    ...
    local items = {{201,1},{201,2},{204,1},{204,2},{321,1},{321,2},{206,1},{206,2},{312,1},{312,2},{2,1000},{2,1500},{2,2000},{9,1000},{9,1500},{9,2000},{1702,1},{1706,1}}
    local len = #items;
    if len  == 0 then
        return 0
	end
