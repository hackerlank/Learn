...
function OnUseItem263(wItemID, wCount, eBind, qwMercenID)
    ...
    if (pack == nil) then
	    ...
	    local sitems = {}
    local prob = {1000,2000,3000,4000,5000,6000,7000,8000,9000,10000}
    local items = {{201,1},{204,1},{321,1},{206,1},{312,1},{2,500},{2,750},{2,1000},{9,500},{9,750},{9,1000},{1702,1},{1706,1}}
    local len = #items;
    if len  == 0 then
        return 0
	end
