...
MonsterActive::MonsterActive(char *_mapId,char *_typeId,char *_nickName,\
...
MonsterActive::~MonsterActive(void)
{

}

MonsterBase* MonsterActive::copyMon(char *_mapId)
{
	...
	newMon = new MonsterActive(_mapId,typeId,nickName,newIntId,type,kind,experience,\
...
/*怪物死亡函数*/
void MonsterActive::die(bool flgInit)
{	
	MonsterBase::die(flgInit);
}

/*重置怪物数据*/
void MonsterActive::initMonsterALL(void)
{
